...
scp -i ~/.ssh/DevOpsStudents.pem -r ~/PycharmProjects/NodeJSAWS_Deploy_code/environment/db ubuntu@3.250.30.246:/home/ubuntu/
...
# Going into db vm
ssh -i ~/.ssh/DevOpsStudents.pem ubuntu@3.250.30.246 -i ./environment/db/provision.sh
