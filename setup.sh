...
scp -i ~/.ssh/DevOpsStudents.pem -r ~/PycharmProjects/NodeJSAWS_Deploy_code/app/ ubuntu@3.250.104.75:/home/ubuntu/

# Linking our provision file into the ubuntu folder of our VM 
scp -i ~/.ssh/DevOpsStudents.pem -r ~/PycharmProjects/NodeJSAWS_Deploy_code/environment/app/provision.sh ubuntu@3.250.104.75:/home/ubuntu/
...
ssh -i ~/.ssh/DevOpsStudents.pem ubuntu@3.250.104.75 -i ./environment/app/provision.sh
