...
scp -i ~/.ssh/DevOpsStudents.pem -r ~/PycharmProjects/NodeJSAWS_Deploy_code/app/ ubuntu@52.215.205.193:/home/ubuntu/

# Linking our provision file into the ubuntu folder of our VM 
scp -i ~/.ssh/DevOpsStudents.pem -r ~/PycharmProjects/NodeJSAWS_Deploy_code/environment/app/provision.sh ubuntu@52.215.205.193:/home/ubuntu/
...
ssh -i ~/.ssh/DevOpsStudents.pem ubuntu@52.215.205.193 -i ./environment/app/provision.sh
